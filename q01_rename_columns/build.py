...
def q01_rename_columns(path=path):
    ...
    df.rename(columns={'Unnamed: 0': 'Country','01 !':'Gold_Summer','02 !':'Silver_Summer','03 !':'Bronze_Summer',
                  ...
                  '01 !.2':'Gold_Total','02 !.2':'Silver_Total','03 !.2':'Bronze_Total',
                  'Total':'Total_Summer','Total.1':'Total_Winter','Combined total': 'Total'},inplace = True)
