...
def q05_top_10_plotting(OlympicsDF,Top10Summer,Top10Winter,Top10):
    a = OlympicsDF[OlympicsDF['Country_Name'].isin(Top10Summer)]['Total']
    plt.plot(Top10Summer,a)
    plt.show()
    b = OlympicsDF[OlympicsDF['Country_Name'].isin(Top10Winter)]['Total']
    plt.plot(Top10Winter,b)
    plt.show()
    c = OlympicsDF[OlympicsDF['Country_Name'].isin(Top10)]['Total']
    plt.plot(Top10Summer,c)
    plt.show()
