...
def q05_top_10_plotting(OlympicsDF,Top10,Top10Summer,Top10Winter):
    ...
    OlympicsDF2 = OlympicsDF.iloc[:len(OlympicsDF)-1,:]
    
    top_ten_winter = OlympicsDF2.nlargest(10,'Total_Winter')[['Country_Name','Total_Winter']]
    top_ten_summer = OlympicsDF2.nlargest(10,'Total_Summer')[['Country_Name','Total_Summer']]
    top_ten_total = OlympicsDF2.nlargest(10,'Total')[['Country_Name','Total']]
